...
export default {
    data() {
        return {
            benefits: [
                'ENVIO GRATIS DE PAQUETES DE PANAMA PACIFICO A 24 DE DICIEMBRE',
                ...
                'PARTICIPACION PARA GIVEAWAY MENSUAL ($100.00) POR CADA PUNTO ACUMULADO ',
                'PARTICIPACION PARA GIVEAWAY DICIEMBRE PASAJE AEREO 2 PERSONAS POR CADA PUNTO ACUMULADO ',
            ],
        }
    },
    mounted() {
